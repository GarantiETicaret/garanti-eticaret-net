...
{
    [XmlRoot("GVPSRequest")]
    [XmlInclude(typeof(RewardInquiryTransactionRequest))]
    public class RewardInquiryRequest : VPOSRequest
    {
        public static string Execute(RewardInquiryRequest request, Settings settings)
        {
    ...
    public class RewardInquiryTransactionRequest : Transaction
    {
