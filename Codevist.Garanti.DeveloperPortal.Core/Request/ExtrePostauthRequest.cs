...
namespace Codevist.Garanti.DeveloperPortal.Core.Request
{
    ...
    [XmlRoot("GVPSRequest")]
    [XmlInclude(typeof(ExtrePostauthTransactionRequest))]
    public class ExtrePostauthRequest : VPOSRequest
    {
        public static string Execute(ExtrePostauthRequest request, Settings settings)
        {
    ...
    public class ExtrePostauthTransactionRequest : Transaction
    {
