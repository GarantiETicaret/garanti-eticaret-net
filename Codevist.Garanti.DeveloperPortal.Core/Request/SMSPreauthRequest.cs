...
namespace Codevist.Garanti.DeveloperPortal.Core.Request
{
    ...
    [XmlRoot("GVPSRequest")]
    [XmlInclude(typeof(SMSPreauthTransactionRequest))]
    public class SMSPreauthRequest : VPOSRequest
    {
        public static string Execute(SMSPreauthRequest request, Settings settings)
        {
    ...
    public class SMSPreauthTransactionRequest : Transaction
    {
