...
{
    [XmlRoot("GVPSRequest")]
    [XmlInclude(typeof(IdentityInqTransactionRequest))]
    public class IdentityInqRequest : VPOSRequest
    {
        public static string Execute(IdentityInqRequest request, Settings settings)
        {
    ...
    public class IdentityInqTransactionRequest : Transaction
    {
