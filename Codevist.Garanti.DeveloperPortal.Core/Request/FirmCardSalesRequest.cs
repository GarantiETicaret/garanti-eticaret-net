...
{
    [XmlRoot("GVPSRequest")]
    [XmlInclude(typeof(FirmCardSalesTransactionRequest))]
    public class FirmCardSalesRequest : VPOSRequest
    {
        public static string Execute(FirmCardSalesRequest request, Settings settings)
        {
    ...
    public class FirmCardSalesTransactionRequest : Transaction
    {
