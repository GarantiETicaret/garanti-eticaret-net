...
{
    [XmlRoot("GVPSRequest")]
    [XmlInclude(typeof(FirmCardPreauthTransactionRequest))]
    public class FirmCardPreauthRequest : VPOSRequest
    {
        public static string Execute(FirmCardPreauthRequest request, Settings settings)
        {
    ...
    public class FirmCardPreauthTransactionRequest : Transaction
    {
