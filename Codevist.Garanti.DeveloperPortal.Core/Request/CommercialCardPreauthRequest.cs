...
{
    [XmlRoot("GVPSRequest")]
    [XmlInclude(typeof(CommercialCardPreauthTransactionRequest))]
    public class CommercialCardPreauthRequest : VPOSRequest
    {
        public static string Execute(CommercialCardPreauthRequest request, Settings settings)
        {
    ...
    public class CommercialCardPreauthTransactionRequest : Transaction
    {
