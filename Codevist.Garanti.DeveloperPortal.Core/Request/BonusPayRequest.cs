...
{
    [XmlRoot("GVPSRequest")]
    [XmlInclude(typeof(BonusPayTransactionRequest))]
    public class BonusPayRequest : VPOSRequest
    {
        public static string Execute(BonusPayRequest request, Settings settings)
        {
    ...
    public class BonusPayTransactionRequest : Transaction
    {
        ...
        public CepBankRequest CepBank { get; set; }
    }
}
