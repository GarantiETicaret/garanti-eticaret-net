...
{
    [XmlRoot("GVPSRequest")]
    [XmlInclude(typeof(CommercialCardLimitInqTransactionRequest))]
    public class CommercialCardLimitInqRequest : VPOSRequest
    {
    ...
    public class CommercialCardLimitInqTransactionRequest : Transaction
    {
