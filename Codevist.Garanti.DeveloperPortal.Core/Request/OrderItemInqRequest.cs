...
namespace Codevist.Garanti.DeveloperPortal.Core.Request
{
    ...
    [XmlRoot("GVPSRequest")]
    [XmlInclude(typeof(OrderItemInqTransactionRequest))]
    public class OrderItemInqRequest : VPOSRequest
    {
        public static string Execute(OrderItemInqRequest request, Settings settings)
        {
    ...
    public class OrderItemInqTransactionRequest : Transaction
    {
