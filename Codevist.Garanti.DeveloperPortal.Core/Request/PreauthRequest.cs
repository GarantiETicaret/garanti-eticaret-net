...
{
    [XmlRoot("GVPSRequest")]
    [XmlInclude(typeof(PreauthTransactionRequest))]
    public class PreauthRequest : VPOSRequest
    {
        public static string Execute(PreauthRequest request, Settings settings)
        {
    ...
    public class PreauthTransactionRequest : Transaction
    {
