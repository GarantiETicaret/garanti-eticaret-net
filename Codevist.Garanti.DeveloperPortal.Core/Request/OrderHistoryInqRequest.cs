...
{
    [XmlRoot("GVPSRequest")]
    [XmlInclude(typeof(OrderHistoryInqTransactionRequest))]
    public class OrderHistoryInqRequest : VPOSRequest
    {
        public static string Execute(OrderHistoryInqRequest request, Settings settings)
        {
    ...
    public class OrderHistoryInqTransactionRequest : Transaction
    {
