...
{
    [XmlRoot("GVPSRequest")]
    [XmlInclude(typeof(ExtentedCreditSalesTransactionRequest))]
   public class ExtentedCreditSalesRequest : VPOSRequest
    {
        public static string Execute(ExtentedCreditSalesRequest request, Settings settings)
        {
    ...
    public class ExtentedCreditSalesTransactionRequest :Transaction
    {
