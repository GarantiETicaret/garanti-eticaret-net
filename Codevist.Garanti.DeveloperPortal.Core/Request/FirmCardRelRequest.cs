...
namespace Codevist.Garanti.DeveloperPortal.Core.Request
{
    ...
    [XmlRoot("GVPSRequest")]
    [XmlInclude(typeof(FirmCardRelTransactionRequest))]
    public class FirmCardRelRequest : VPOSRequest
    {
        public static string Execute(FirmCardRelRequest request, Settings settings)
        {
    ...
    public class FirmCardRelTransactionRequest : Transaction
    {
        [XmlElement(ElementName = "CurrencyCode")]
        public int CurrencyCode { get; set; }
        [XmlElement(ElementName = "MotoInd")]
        public string MotoInd { get; set; }
        [XmlElement(ElementName = "FirmCardNo")]
